...
def group_created(qtile, group):
    ...
    if  ((group == 'WWW') or (group == 'Editors') or (group == 'Skype') or (group == 'GIMP') or (group == 'Builder') or (group == 'TeamViewer') or (group == 'WeeChat') or (group == 'E-Mail') or (group == 'RDP') or (group == 'Discord') or (group == 'Trello')):
